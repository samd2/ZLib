...
def main(ctx):
  ...
  windows_cxx("msvc-14.2", "", image="cppalliance/dronevs2019", buildtype="boost", environment={"B2_TOOLSET": "msvc-14.2", "B2_CXXSTD": "14,17,latest"}),
  windows_cxx("msvc-14.3", "", image="cppalliance/dronevs2022:1", buildtype="boost", environment={"B2_TOOLSET": "msvc-14.3", "B2_CXXSTD": "17,20"}),
    ]
